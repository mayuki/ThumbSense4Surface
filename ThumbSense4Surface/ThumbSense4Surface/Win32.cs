...
namespace ThumbSense4SurfacePro
{
    internal class Win32
    {
        ...
        public static extern UInt32 SendInput(UInt32 nInputs,
            [MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.LPStruct)] INPUT[] pInputs, Int32 cbSize);
        ...
        public struct KeyboardHookEventStruct
        {
            ...
            {
                return String.Format("wVk:{0}, wScan:{1}, dwFlags:{2}, dwExtraInfo(Ptr):{3}", wVk, wScan, dwFlags,
                    dwExtraInfo);
            }
        }
        ...
        [DllImport("user32.dll")]
        public static extern uint GetRawInputDeviceInfo(IntPtr deviceHandle, uint command, ref DeviceInfo data,
            ref uint dataSize);
        ...
        /// <returns>0 if successful if pData is null, otherwise number of bytes if pData is not null.</returns>
        [DllImport("user32.dll")]
        public static extern int GetRawInputData(IntPtr hRawInput, RawInputCommand uiCommand, IntPtr pData,
            ref int pcbSize, int cbSizeHeader);
